module terramatter.core.math.dlibwrapper;
...
template rotated( T ) {
    ...
    */
    Vector!(T, 3) rotated(Vector!(T, 3) v, Vector!(T, 3) x, T theta) {
    ...
    * Returns: Rotated vector
    */
    Vector!(T, 3) rotatedDegrees(Vector!(T, 3) vec, Vector!(T, 3) axis, T deg) {
